...
## ⚡TL;DR 
Designed and built a complete analytics pipeline for **1M+ e-commerce transactions** using PostgreSQL and Power BI.

Implemented ETL, star-schema modelling, SQL optimisation (6× performance improvement), and BI dashboards that uncover **$17.7M total revenue, 72.3% repeat purchase rate**, and **$3M+ generated by top 10 customers**.
