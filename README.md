...
End-to-end SQL & Business Intelligence Project (PostgreSQL + Power BI)


🔗 GitHub Repository: https://github.com/Samson-tech-code/ecommerce-sql-analytics
---

## ⚡TL;DR 
Built an end-to-end SQL and BI analytics pipeline for 1M+ e-commerce transactions.

• Designed a star-schema data model in PostgreSQL  
• Optimised SQL queries (5.7× faster performance)  
• Built executive Power BI dashboards for revenue, customers, and products  
• Generated insights to support marketing, retention, and inventory decisions

## 👥 Stakeholders & Use Case
This analysis is designed to support:
- Commercial Managers (revenue & customer performance)
- Marketing teams (retention and VIP customer strategy)
- Operations teams (seasonality and product demand planning)

The outputs simulate weekly and monthly performance reporting used in retail organisations.
...
End-to-end data analytics pipeline analyzing **1+ million e-commerce transactions** using PostgreSQL for data transformation and Power BI for interactive dashboards.

This project demonstrates a full **data analytics workflow**, including:

- Data ingestion (1,067,371 transaction rows from Online Retail II)
- Data cleaning & transformation using SQL
- Normalised relational modelling + star schema
- Query optimisation (indexing, materialised views)
- Executive-level dashboards (Power BI)
- Insight generation for business decision-making

It replicates what a Data Analyst / BI Analyst does in a real retail organisation.

---

## 🎯 Business Problem
The analysis supports recurring monthly and quarterly reporting, with KPIs designed for executive dashboards and performance reviews.

The project was designed to answer key business questions:

##### 1. When are sales highest? (seasonality, monthly trends)

##### 2. Who are the most valuable customers?

##### 3. Which products drive the most revenue?

##### 4. How do customer segments behave?

##### 5. Which geographic markets perform best?

##### 6. What improvements should be made to retention & product strategy?
...
- **Analytics:** SQL (CTEs, window functions, aggregation, joins)
...
- **OS**: Windows
- **Dataset:** [Online Retail II](https://www.kaggle.com/datasets/mashlyn/online-retail-ii)
...
├── docs/
│   ├── dashboard_page1.png       # Power BI visualisations
│   └── dashboard_page2.png
├── powerbi/
│   └── ecommerce_dashboard.pbix  # Full interactive dashboard
└── README.md
```
...
1. **Focus on Q4 Marketing:** November peak across both years - invest in holiday campaigns
